...
#$TTSDIR="../../../../data/sensysData/7-Apr-ATA-TOTAL/tts_results";
$TTSDIR="data/";
$OUTFILE="tts.bars";
...
print BARS "Key: right-(1.25*inch), top-(2.5*inch): : -keywidth 1 -keytitlealign right -textfont helvetica10 -fillcolor white -keyframe -elemwidth 0.1 -elemheight 0.1\n";
