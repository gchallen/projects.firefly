...
##$TTSDIR="../../../../data/sensysData/7-Apr-ATA-TOTAL/ps_results/";
$TTSDIR="graphData/";
$OUTFILE="percent-synch.bars";
@FFLIST=(70,100,300,500,750,1000);
...
print BARS "YAxis: Percentage Synchronized (%): -labelalign center -labeldist 0.5 -grid -setmax $maxy\n";
