...
# set terminal postscript landscape enhanced color colortext \
   ...
   butt "Helvetica" 14
# set output '11-Jan-2005-1-16MOTES-150CONSTANT-RING-EVENT-ALL-GROUPS.ps'
unset clip points
set clip one
unset clip two
set bar 1.000000
...
set title "Acheiving Synchronization with 16 Nodes" 0.000000,0.000000  font ""
...
set ylabel "Group Size" 0.000000,0.000000  font ""
set y2label "" 0.000000,0.000000  font ""
set yrange [ 0.00000 : 20.0000 ] noreverse nowriteback
...
plot '11-Jan-2005-1-16MOTES-150CONSTANT-RING-EVENT-ALL-GROUPS.out' u 2:3 w points title ""
#    EOF
